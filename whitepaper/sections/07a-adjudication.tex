...
their committed output text. For an attested entry, validators also
check its version-bound execution receipt under Section~\ref{attested-b-models};
...
Attested B records also retain their verified receipt, instance evidence
