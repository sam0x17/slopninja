...
timeout refunds. This payment choice remains open before paid launch. A proposed
alternative would release payment on verified agreed execution and complete
customer-encrypted delivery, with editorial refunds under separately
accepted terms. It requires a specified receipt-verification and
ciphertext-availability path; a hash or delivery claim is insufficient.
That alternative is not the adopted pilot settlement rule.
