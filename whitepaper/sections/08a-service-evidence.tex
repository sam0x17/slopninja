...
A models and nominated monthly B checkpoints are public. B training
service may use newer private generators. The requester counters,
...
Training-ticket transport does not require replay of the private service
generator. The separate common B reward benchmark requires execution of
the nominated public checkpoint under Section~\ref{monthly-b-release}.
Insufficient final review evidence voids the shared
...
A publication and monthly B publication, with artifact qualification,
are separate eligibility gates.
