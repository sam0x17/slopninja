...
Attested private customer jobs use a separate instance-key and receipt
flow; these curator-authorized generation witnesses must never export
customer keys or override that boundary. Private customer jobs retain their paid lifecycle and never enter
