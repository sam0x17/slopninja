...
are idempotent and conflicting signed manifests remain evidence. The
...
means no provider obligation. The provider's decline, absent publication,
...
under Section~\ref{reward-adjudication}. The companion service-evidence
specification~\cite{serviceevidence} defines the detailed record and
certificate rules.
