...
semantic judgments correct or an A service's reported probabilities
faithful to private weights. Native Yuma also processes each validator's
submitted weights independently. A valid benchmark certificate cannot
force a dishonest validator to submit its prescribed weight row. The
settlement counterexample in Section~\ref{existing-evidence-and-implementation-status}
therefore remains relevant even below one-third dishonest voting weight.
