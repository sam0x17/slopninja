...
prototype. Shared-pool experiments show why complementary credits alone
do not prevent collusion; the design instead removes private A score
reports from benchmark authority. Published detectors still require
independent qualification and checks for behavior that favors allied B
models. A reliable rewriting model, private inference service, and live
