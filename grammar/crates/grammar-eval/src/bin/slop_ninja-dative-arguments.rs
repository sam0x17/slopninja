//! Confirm role-aware argument policies and replay the bound author corpus.
#[path = "../dative_alternation.rs"]
pub mod dative_alternation;
#[path = "../dative_argument_study.rs"]
mod dative_argument_study;
