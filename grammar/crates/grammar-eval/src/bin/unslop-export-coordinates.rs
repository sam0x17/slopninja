...
#[derive(Parser)]
#[command(about = "Export named coordinate contributions with complete frozen-family residuals")]
struct Args {
    evaluation: PathBuf,
    #[arg(long)]
    export: PathBuf,
...
fn run(args: Args) -> Result<()> {
    ...
    write(
        ...
        &json!({"schema":"slopninja-coordinate-export-v1","split":args.split,
        ...
        "input_bindings":bindings,"audit_sha256":hash(&fs::read(args.out.join("audit.json"))?),
        ...
        "source_sha256":{"coordinates.rs":hash(include_bytes!("../coordinates.rs")),"exporter.rs":hash(include_bytes!("unslop-export-coordinates.rs")),"neural.rs":hash(include_bytes!("../neural.rs"))},
